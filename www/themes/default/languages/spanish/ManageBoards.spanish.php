...
$txt['boards_and_cats_desc'] = 'Edita tus foros y categorías aquí. Lista múltiples moderadores como <em>&quot;nombre de usuario&quot;, &quot;nombre de usuario&quot;</em>. (deben de ser los nombres de usuario y *no* los nombres a mostrar)<br />Para crear un nuevo foro, presiona el botón "Añadir Foro".<br />Para mover un foro, puedes agarrar y soltarlo a su nuevo lugar en la lista (entre categorías y foros)<br />Para crear un nuevo foro como subforo del foro actual, selecciona "Subforo de..." del menú desplegable al crear un nuevo foro.';
$txt['parent_members_only'] = 'Usuarios regulares';
...
$txt['mboards_board_error'] = 'Fallo al mover de sitio';
...
$txt['mboards_delete_board_contains'] = 'Al borrar este foro, también borrarás los subforos siguientes, incluyendo todos los temas, mensajes y adjuntos dentro de cada foro';
$txt['mboards_delete_board_option1'] = 'Borrar foro y mover subforos al nivel de la categoría';
$txt['mboards_delete_board_option2'] = 'Borrar foro y mover subforos a';
...
$txt['mboards_recycle_disabled_delete'] = 'Debes seleccionar una papelera de reciclaje alternativa antes de borrar este foro';
...
$txt['deny_boards_access'] = 'Habilita la opción de denegar el acceso al foro basado en los grupos de miembros';
$txt['boardsaccess_option_desc'] = 'Para cada permiso, puedes elegir "Permitir" (A), "Ignorar" (X), o <span class="alert">"Denegar" (D)</span>.<br /><br />Si quieres denegar el acceso, cualquier miembro (incluyendo moderadores) en ese grupo no podrá acceder al foro.<br />Por esta razón, deberías establecer "Denegar" cuidadosamente, solo cuando sea <strong>necesario</strong>. Por otro lado, "Ignorar" deniega a menos que esté garantizado.';
